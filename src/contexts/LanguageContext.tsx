...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.leaderboard.points_system_help": "Set how many points volunteers earn automatically when they register for a campaign and when their attendance is confirmed.",
  ...
  fr: {
    ...
    "admin.leaderboard.points_system_help": "Définissez combien de points les bénévoles gagnent automatiquement lors de l'inscription à une campagne et lorsque leur présence est confirmée.",
  ...
  ar: {
    ...
    "admin.leaderboard.points_system_help": "حدد عدد النقاط التي يكتسبها المتطوعون تلقائياً عند التسجيل في حملة وتأكيد حضورهم.",
