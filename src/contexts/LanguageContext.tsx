...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'hero.subheading': 'Join a community of citizens committed to cleaner streets, greener parks, and a healthier Meknes.',
    'hero.cta': 'Join a Campaign',
    'hero.cta_unauth': 'Join the Movement',

    'donation.label': 'DONATE',
    'donation.title': 'Support Our Mission',
    'donation.description': 'Your contribution helps us organize more cleanups and spread awareness across Meknes.',
    ...
    'donation.impact_1': 'Cleaning supplies (gloves, bags, tools) for {campaigns}+ campaigns per year',
    'donation.impact_2': 'Refreshments and safety equipment for {volunteers}+ volunteers',
    'donation.impact_3': 'Educational materials and awareness campaigns across {neighborhoods} neighborhoods',
    ...
    'testimonials.subheading': 'Real stories from citizens making Meknes cleaner.',
    'testimonials.label': 'TESTIMONIALS',
    'testimonials.empty': 'No testimonials yet.',

    'community.label': 'COMMUNITY',
    'community.heading': 'Community Voices',
    'community.subheading': 'Explore stories, partners, social updates, and more from our growing community.',
    ...
    'join.card1.body': 'Sign up for upcoming cleanup campaigns. We provide all the tools — gloves, bags, and refreshments. You bring the energy.',
    'join.card1.cta': 'View Campaigns',
    'join.card2.title': 'Spread the Word',
    'join.card2.body': 'Share our campaigns on social media. Every share brings new volunteers and raises awareness about keeping Meknes clean.',
    'join.card2.cta': 'Share Now',
    'join.card3.title': 'Partner With Us',
    'join.card3.body': 'Organizations, schools, and businesses can sponsor campaigns or organize corporate cleanup days. Let\'s collaborate.',
    ...
    'faq.a1': 'We provide gloves, trash bags, and basic tools. Just bring water, comfortable clothes, and your enthusiasm!',
    'faq.q2': 'Is there an age limit?',
    'faq.a2': 'Volunteers of all ages are welcome! Children under 16 should be accompanied by an adult. We have tasks suitable for everyone.',
    'faq.q3': 'How long do campaigns last?',
    'faq.a3': 'Most campaigns last 2-4 hours, typically on weekend mornings. We always announce the exact duration when you register.',
    'faq.q4': 'Can I organize a campaign in my neighborhood?',
    'faq.a4': 'Absolutely! Contact us through the form below and we will help you plan and promote a cleanup in your area.',
    'faq.q5': 'Is it safe to volunteer?',
    'faq.a5': 'Yes, safety is our priority. We provide safety briefings, first aid kits, and never work in dangerous areas. All volunteers are covered by our insurance.',

    'campaigns.heading': 'Upcoming Campaigns',
    'campaigns.subheading': 'Click a filter or hover pins on the tactical map to find campaigns by theme.',
    'campaigns.canvas.placeholder': 'Draw your commitment',
    'campaigns.canvas.instruction': 'Draw a shape to discover your next campaign',
    ...
    'campaign.1.description': 'Join 50+ volunteers for a morning cleanup around the iconic Bab Mansour gate and surrounding plaza.',
    'campaign.2.title': 'Ville Nouvelle Park Refresh',
    'campaign.2.location': 'Avenue My Ismail, Ville Nouvelle',
    'campaign.2.description': 'Help restore the beauty of Ville Nouvelle parks. Tree planting, litter collection, and bench repairs.',
    'campaign.3.title': 'Hamria Market Deep Clean',
    'campaign.3.location': 'Marche Hamria, Hamria',
    'campaign.3.description': 'A thorough cleanup of the Hamria market area. Focus on waste sorting and recycling education.',
    'campaign.4.title': 'Borj Belkari Trail Clean',
    'campaign.4.location': 'Borj Belkari, Route de Fes',
    'campaign.4.description': 'Outdoor trail cleanup along the scenic Borj Belkari route. Great for nature lovers and hikers.',

    'contact.label': 'CONTACT',
    'contact.heading': 'Get in Touch',
    'contact.body': 'Have questions about volunteering, partnerships, or organizing a cleanup in your neighborhood? Reach out — we reply within 24 hours.',
    ...
    'contact.form_subtitle': 'Fill out the form below and we will get back to you.',
    ...
    'socialFeed.subheading': 'Follow our journey and see what our community is sharing across platforms.',
    'sponsors.label': 'PARTNERS',
    'partners.empty': 'No partners yet.',
    'sponsors.heading': 'Our Partners & Sponsors',
    'sponsors.subheading': 'Organizations and businesses supporting our mission for a cleaner Meknes.',
    'gallery.heading': 'Before & After',
    'gallery.subheading': 'See the real impact our volunteers make across Meknes.',
    ...
    'volunteer.form_subtitle': 'Fill out the form below and an admin will review your application.',
    ...
    'volunteer.success': 'Application submitted successfully! An admin will review it soon.',
    ...
    'air_quality.subheading': 'Live air quality data for Meknes. Updated hourly from Open-Meteo.',
    'air_quality.aqi_good': 'Air quality is good. Enjoy outdoor activities!',
    'air_quality.aqi_moderate': 'Air quality is moderate. Sensitive individuals should limit prolonged outdoor exertion.',
    'air_quality.aqi_sensitive': 'Air quality is unhealthy for sensitive groups. Consider wearing a mask outdoors.',
    'air_quality.aqi_unhealthy': 'Air quality is unhealthy. Avoid prolonged outdoor activities and wear a mask.',
    'air_quality.advice_good': 'Air quality is good. Enjoy outdoor activities!',
    'air_quality.advice_moderate': 'Air quality is moderate. Sensitive individuals should limit prolonged outdoor exertion.',
    'air_quality.advice_sensitive': 'Air quality is unhealthy for sensitive groups. Consider wearing a mask outdoors.',
    'air_quality.advice_unhealthy': 'Air quality is unhealthy. Avoid prolonged outdoor activities and wear a mask.',
    ...
    'air_quality.pm25_desc': 'Fine particles that can penetrate deep into lungs',
    ...
    'air_quality.scale_desc': 'The Air Quality Index (AQI) runs from 0 to 500. The higher the value, the greater the level of air pollution and health concern.',
    'air_quality.how_title': 'Understanding Air Quality',
    'air_quality.what_is_aqi': 'What is AQI?',
    'air_quality.what_is_aqi_desc': 'The Air Quality Index (AQI) is a standardized scale used worldwide to communicate how polluted the air currently is or how polluted it is forecast to become. It converts complex pollutant measurements into a single easy-to-understand number.',
    'air_quality.how_measured': 'How is it measured?',
    'air_quality.how_measured_desc': 'Air quality stations measure concentrations of key pollutants in the atmosphere — PM2.5, PM10, NO₂, SO₂, CO, and O₃. These measurements are fed into a formula that calculates a single AQI value. The pollutant with the highest individual index determines the overall AQI.',
    'air_quality.pollutants_title': 'What are these pollutants?',
    'air_quality.pollutants_desc': 'PM2.5 and PM10 are tiny solid or liquid particles suspended in air. NO₂ comes mainly from vehicle exhaust and industrial emissions. SO₂ is produced by burning fossil fuels. CO is a colorless gas from incomplete combustion. O₃ (ozone) forms when sunlight reacts with other pollutants.',
    'air_quality.data_source': 'Where does this data come from?',
    'air_quality.data_source_desc': 'This data is sourced from Open-Meteo, a global weather and air quality API that aggregates data from national monitoring stations and satellite observations. When live data is unavailable, we display realistic simulated values based on typical Meknes conditions.',
    ...
    'error.modal.network': 'Network error. Please check your connection and try again.',
    'error.modal.auth': 'Authentication failed. Please log in again.',
    'error.modal.generic': 'Something went wrong. Please try again.',
    'error.modal.oauth_denied': 'Login was cancelled. You can try again whenever you are ready.',
    'error.modal.oauth_failed': 'Login failed. Please try again or use a different method.',
    'error.modal.rate_limit': 'Too many attempts. Please wait a moment and try again.',
    'error.modal.csrf': 'Security validation failed. Please try again.',
    'error.modal.pkce': 'Login session expired. Please try again.',
    'error.modal.redirect': 'Invalid redirect. Please try again from the home page.',
    'error.modal.permission': 'You do not have permission to perform this action.',
    'error.modal.not_found': 'The requested resource was not found.',
    'error.modal.server': 'Server error. Please try again later.',
    'error.modal.offline': 'You appear to be offline. Please check your connection.',
    'error.modal.unauthorized': 'You need to be logged in to perform this action.',
    ...
    'neighborhoods.subheading': 'Discover the communities we serve across Meknes.',
    'neighborhoods.loading': 'Loading neighborhoods...',
    'neighborhoods.not_found': 'Neighborhood Not Found',
    'neighborhoods.not_found_desc': 'The neighborhood you are looking for does not exist.',
  ...
  fr: {
    ...
    'hero.subheading': 'Rejoignez une communaute de citoyens engages pour des rues plus propres, des parcs plus verts et un Meknes plus sain.',
    ...
    'join.card1.body': 'Inscrivez-vous aux prochaines campagnes de nettoyage. Nous fournissons tout le materiel — gants, sacs et rafraichissements. Vous apportez l\'energie.',
    'join.card1.cta': 'Voir les Campagnes',
    'join.card2.title': 'Passer le Mot',
    'join.card2.body': 'Partagez nos campagnes sur les reseaux sociaux. Chaque partage attire de nouveaux benevoles et sensibilise a la propreté de Meknes.',
    'join.card2.cta': 'Partager',
    'join.card3.title': 'Devenir Partenaire',
    'join.card3.body': 'Les organisations, ecoles et entreprises peuvent sponsoriser des campagnes ou organiser des journees de nettoyage. Collaborons.',
    'join.card3.cta': 'Nous Contacter',

    'faq.label': 'FAQ',
    'faq.empty': 'Aucune FAQ pour le moment.',
    'faq.heading': 'Questions Fréquentes',
    'faq.subheading': 'Tout ce que vous devez savoir avant de rejoindre une campagne.',
    'faq.q1': 'Dois-je apporter quelque chose ?',
    'faq.a1': 'Nous fournissons des gants, des sacs poubelles et des outils de base. Apportez juste de l\'eau, des vêtements confortables et votre enthousiasme !',
    'faq.q2': 'Y a-t-il une limite d\'âge ?',
    'faq.a2': 'Les bénévoles de tous âges sont les bienvenus ! Les enfants de moins de 16 ans doivent être accompagnés d\'un adulte. Nous avons des tâches adaptées à tout le monde.',
    'faq.q3': 'Combien de temps durent les campagnes ?',
    'faq.a3': 'La plupart des campagnes durent 2 à 4 heures, généralement le matin en week-end. Nous annonçons toujours la durée exacte lors de votre inscription.',
    'faq.q4': 'Puis-je organiser une campagne dans mon quartier ?',
    'faq.a4': 'Absolument ! Contactez-nous via le formulaire ci-dessous et nous vous aiderons à planifier et promouvoir un nettoyage dans votre quartier.',
    'faq.q5': 'Est-il sûr de faire du bénévolat ?',
    'faq.a5': 'Oui, la sécurité est notre priorité. Nous fournissons des briefings de sécurité, des trousses de premiers secours et ne travaillons jamais dans des zones dangereuses. Tous les bénévoles sont couverts par notre assurance.',

    'donation.label': 'FAIRE UN DON',
    'donation.title': 'Soutenez Notre Mission',
    'donation.description': 'Votre contribution nous aide a organiser plus de nettoyages et a sensibiliser les gens a travers Meknes.',
    ...
    'donation.impact_1': 'Fournitures de nettoyage (gants, sacs, outils) pour {campaigns}+ campagnes par an',
    'donation.impact_2': 'Rafraichissements et equipement de securite pour {volunteers}+ benevoles',
    'donation.impact_3': 'Materiel educatif et campagnes de sensibilisation dans {neighborhoods} quartiers',
    'donation.impact_4': 'Projets de plantation d arbres et de restauration des espaces verts',
    ...
    'impact.subheading': 'Des chiffres réels de vraies campagnes à travers Meknès.',
    ...
    'testimonials.subheading': 'Des histoires réelles de citoyens qui rendent Meknès plus propre.',
    ...
    'community.subheading': 'Découvrez les histoires, les partenaires, les actualités sociales et plus encore de notre communauté en pleine croissance.',
    ...
    'campaigns.discover_body': 'Dessinez une forme sur ce canvas pour filtrer les campagnes. Chaque forme met en valeur differents types de campagnes.',
    'campaigns.instruction_fallback': 'Dessinez une forme ou appuyez sur un bouton pour filtrer les campagnes',
    'campaigns.heading': 'Campagnes a Venir',
    'campaigns.subheading': 'Cliquez sur un filtre ou survolez les points sur la carte tactique pour trouver des campagnes par theme.',
    'campaigns.canvas.placeholder': 'Dessinez votre engagement',
    'campaigns.canvas.instruction': 'Dessinez une forme pour decouvrir votre prochaine campagne',
    ...
    'campaign.1.description': 'Rejoignez plus de 50 benevoles pour un nettoyage matinal autour de la celebre porte Bab Mansour et de la place environnante.',
    'campaign.2.title': 'Rafraichissement Parc Ville Nouvelle',
    'campaign.2.location': 'Avenue My Ismail, Ville Nouvelle',
    'campaign.2.description': 'Aidez a restaurer la beaute des parcs de Ville Nouvelle. Plantation d\'arbres, collecte de dechets et reparation de bancs.',
    'campaign.3.title': 'Nettoyage en Profondeur Marche Hamria',
    'campaign.3.location': 'Marche Hamria, Hamria',
    'campaign.3.description': 'Un nettoyage approfondi de la zone du marche Hamria. Focus sur le tri des dechets et l\'education au recyclage.',
    'campaign.4.title': 'Nettoyage Sentier Borj Belkari',
    'campaign.4.location': 'Borj Belkari, Route de Fes',
    'campaign.4.description': 'Nettoyage de sentier en plein air le long de la route panoramique de Borj Belkari. Ideal pour les amoureux de la nature.',

    'contact.label': 'CONTACT',
    'contact.heading': 'Prenez Contact',
    'contact.body': 'Vous avez des questions sur le benevolat, les partenariats ou l\'organisation d\'un nettoyage dans votre quartier ? Contactez-nous — nous repondons sous 24 heures.',
    ...
    'contact.form_subtitle': 'Remplissez le formulaire ci-dessous et nous vous repondrons.',
    'contact.send_another': 'Envoyer un autre message',

    'footer.tagline': 'Rues Plus Propres. Parcs Plus Verts. Communaute Plus Forte.',
    ...
    'socialFeed.subheading': 'Suivez notre parcours et découvrez ce que notre communauté partage sur les réseaux.',
    'sponsors.label': 'PARTENAIRES',
    'partners.empty': 'Aucun partenaire pour le moment.',
    'sponsors.heading': 'Nos Partenaires & Sponsors',
    'sponsors.subheading': 'Des organisations et entreprises soutenant notre mission pour un Meknès plus propre.',
    'gallery.heading': 'Avant & Après',
    'gallery.subheading': 'Découvrez l\'impact réel de nos bénévoles à travers Meknès.',
    ...
    'login.or': 'ou',
    'login.terms': 'En vous connectant, vous acceptez nos Conditions d\'utilisation et notre Politique de confidentialite.',

    'volunteer.form_title': 'Devenez Benevole',
    'volunteer.form_subtitle': 'Remplissez le formulaire ci-dessous et un administrateur examinera votre candidature.',
    ...
    'volunteer.success': 'Candidature soumise avec succes ! Un administrateur l\'examinera bientot.',
    'volunteer.register_another': 'Inscrire un autre benevole',

    'profile.my_campaigns': 'Mes Campagnes',
    'profile.no_campaigns': 'Vous ne vous etes inscrit a aucune campagne pour le moment.',
    ...
    'air_quality.subheading': 'Données en direct sur la qualité de l\'air à Meknès. Mises à jour horaires depuis Open-Meteo.',
    'air_quality.advice_good': 'La qualité de l\'air est bonne. Profitez des activités en plein air !',
    'air_quality.advice_moderate': 'La qualité de l\'air est modérée. Les personnes sensibles devraient limiter les efforts prolongés en plein air.',
    'air_quality.advice_sensitive': 'La qualité de l\'air est malsaine pour les groupes sensibles. Envisagez de porter un masque à l\'extérieur.',
    'air_quality.advice_unhealthy': 'La qualité de l\'air est malsaine. Évitez les activités prolongées en plein air et portez un masque.',
    ...
    'air_quality.pm25_desc': 'Particules fines pouvant pénétrer profondément dans les poumons',
    'air_quality.pm10_desc': 'Particules grossières provenant de la poussière et du pollen',
    'air_quality.no2_desc': 'Dioxyde d\'azote provenant du trafic et de l\'industrie',
    ...
    'air_quality.scale_desc': 'L\'Indice de Qualité de l\'Air (AQI) va de 0 à 500. Plus la valeur est élevée, plus le niveau de pollution atmosphérique et de risque pour la santé est grand.',
    'air_quality.how_title': 'Comprendre la Qualité de l\'Air',
    'air_quality.what_is_aqi': 'Qu\'est-ce que l\'AQI ?',
    'air_quality.what_is_aqi_desc': 'L\'Indice de Qualité de l\'Air (AQI) est une échelle standardisée utilisée dans le monde entier pour communiquer le niveau de pollution atmosphérique actuel ou prévu. Il convertit des mesures complexes de polluants en un seul nombre facile à comprendre.',
    'air_quality.how_measured': 'Comment est-ce mesuré ?',
    'air_quality.how_measured_desc': 'Les stations de qualité de l\'air mesurent les concentrations de polluants clés dans l\'atmosphère — PM2.5, PM10, NO₂, SO₂, CO et O₃. Ces mesures sont intégrées dans une formule qui calcule une valeur AQI unique. Le polluant avec l\'indice individuel le plus élevé détermine l\'AQI global.',
    'air_quality.pollutants_title': 'Que sont ces polluants ?',
    'air_quality.pollutants_desc': 'Les PM2.5 et PM10 sont de minuscules particules solides ou liquides en suspension dans l\'air. Le NO₂ provient principalement des échappements de véhicules et des émissions industrielles. Le SO₂ est produit par la combustion de combustibles fossiles. Le CO est un gaz incolore provenant d\'une combustion incomplète. L\'O₃ (ozone) se forme lorsque la lumière du soleil réagit avec d\'autres polluants.',
    'air_quality.data_source': 'D\'où viennent ces données ?',
    'air_quality.data_source_desc': 'Ces données proviennent d\'Open-Meteo, une API mondiale de météo et de qualité de l\'air qui agrège des données de stations de surveillance nationales et d\'observations satellites. Lorsque les données en direct ne sont pas disponibles, nous affichons des valeurs simulées réalistes basées sur les conditions typiques de Meknès.',

    'poll.heading': 'Sondage Communautaire',
    'poll.subheading': 'Donnez votre avis sur ce qui compte le plus pour Meknès.',
    ...
    'error.modal.network': 'Erreur réseau. Veuillez vérifier votre connexion et réessayer.',
    ...
    'error.modal.oauth_denied': 'La connexion a été annulée. Vous pouvez réessayer quand vous voulez.',
    'error.modal.oauth_failed': 'La connexion a échoué. Veuillez réessayer ou utiliser une autre méthode.',
    'error.modal.rate_limit': 'Trop de tentatives. Veuillez attendre un moment et réessayer.',
    ...
    'error.modal.redirect': 'Redirection invalide. Veuillez réessayer depuis la page d\'accueil.',
    'error.modal.permission': 'Vous n\'avez pas la permission d\'effectuer cette action.',
    ...
    'error.modal.offline': 'Vous semblez hors ligne. Veuillez vérifier votre connexion.',
    'error.modal.unauthorized': 'Vous devez être connecté pour effectuer cette action.',
    ...
    'neighborhoods.subheading': 'Découvrez les communautés que nous servons à travers Meknès.',
    'neighborhoods.loading': 'Chargement des quartiers...',
    'neighborhoods.not_found': 'Quartier Non Trouvé',
    'neighborhoods.not_found_desc': 'Le quartier que vous recherchez n\'existe pas.',
    'neighborhoods.back_home': 'Retour à l\'accueil',
    'neighborhoods.location': 'Meknès, Maroc',
    'neighborhoods.stats': 'Statistiques d\'Impact',
    'share.text': 'Rejoignez le nettoyage {title} a Meknes le {date} ! {description}',
  ...
  ar: {
    ...
    'hero.subheading': 'انضم إلى مجتمع من المواطنين الملتزمين بشوارع أنظف وحدائق أخضر ومكناس أكثر صحة.',
    'hero.cta': 'انضم إلى حملة',
    'hero.cta_unauth': 'انضم إلى الحركة',

    'about.label': 'حول المبادرة',
    'about.heading': 'حركة انطلقت من شوارع مكناس',
    'about.body': 'جرين مكناس هي مبادرة مواطنة تجمع بين الأفراد والأحياء والمنظمات المحلية لاتخاذ إجراءات مباشرة ضد القمامة والتلوث في مدينتنا. منذ عام 2023، نظمنا أكثر من 40 حملة تنظيف في جميع أنحاء مكناس، مما حشد مئات المتطوعين وأزال أطنانًا من النفايات من الأماكن العامة. مهمتنا بسيطة: مكناس أنظف تبدأ بكل واحد منا.',
    'about.stat1.number': '40+',
    ...
    'join.card1.body': 'سجل في حملات التنظيف القادمة. نوفر جميع الأدوات — القفازات والأكياس والمشروبات. أنت تجلب الطاقة.',
    'join.card1.cta': 'عرض الحملات',
    'join.card2.title': 'انشر الخبر',
    'join.card2.body': 'شارك حملاتنا على وسائل التواصل الاجتماعي. كل مشاركة تجلب متطوعين جدد وتزيد الوعي حول الحفاظ على نظافة مكناس.',
    'join.card2.cta': 'شارك الآن',
    'join.card3.title': 'كن شريكًا',
    'join.card3.body': 'يمكن للمنظمات والمدارس والشركات رعاية الحملات أو تنظيم أيام تنظيف للشركات. لنتعاون.',
    ...
    'faq.a1': 'نوفر القفازات وأكياس القمامة والأدوات الأساسية. فقط أحضر الماء والملابس المريحة وحماستك!',
    'faq.q2': 'هل هناك حد عمر؟',
    'faq.a2': 'المتطوعون من جميع الأعمار مرحب بهم! يجب أن يكون الأطفال دون 16 عامًا برفقة شخص بالغ. لدينا مهام مناسبة للجميع.',
    'faq.q3': 'كم تستمر الحملات؟',
    'faq.a3': 'تستمر معظم الحملات من 2 إلى 4 ساعات، عادة في صباحات عطلة نهاية الأسبوع. نعلن دائمًا عن المدة الدقيقة عند تسجيلك.',
    'faq.q4': 'هل يمكنني تنظيم حملة في حيّي؟',
    'faq.a4': 'بالتأكيد! تواصل معنا عبر النموذج أدناه وسنساعدك في التخطيط والترويج لحملة تنظيف في منطقتك.',
    'faq.q5': 'هل التطوع آمن؟',
    'faq.a5': 'نعم، السلامة هي أولويتنا. نقدم إحاطات أمنية وحقائب إسعافات أولية ولا نعمل أبدًا في مناطق خطرة. جميع المتطوعين مغطيون بتأميننا.',

    'donation.label': 'تبرع',
    'donation.title': 'ادعم مهمتنا',
    'donation.description': 'مساهمتك تساعدنا في تنظيم المزيد من حملات التنظيف ونشر الوعي في جميع أنحاء مكناس.',
    ...
    'donation.impact_1': 'مستلزمات التنظيف (قفازات، أكياس، أدوات) لـ {campaigns}+ حملة سنويًا',
    'donation.impact_2': 'المشروبات والمعدات الأمنية لـ {volunteers}+ متطوع',
    'donation.impact_3': 'المواد التعليمية وحملات التوعية في {neighborhoods} حي',
    ...
    'community.subheading': 'استكشف القصص والشركاء والتحديثات الاجتماعية والمزيد من مجتمعنا المتنامي.',
    ...
    'campaigns.discover_body': 'ارسم شكلًا على هذه اللوحة لتصفية الحملات. كل شكل يسلط الضوء على أنواع مختلفة من الحملات.',
    'campaigns.instruction_fallback': 'ارسم شكلًا أو اضغط على زر لتصفية الحملات',
    'campaigns.heading': 'الحملات القادمة',
    'campaigns.subheading': 'انقر على فلتر أو مرر فوق الدبابيس على الخريطة التكتيكية للعثور على الحملات حسب الموضوع.',
    ...
    'campaign.1.description': 'انضم إلى أكثر من 50 متطوعًا لتنظيف صباحي حول بوابة باب المنصور الأيقونية والساحة المحيطة بها.',
    'campaign.2.title': 'تجديد حديقة المدينة الجديدة',
    'campaign.2.location': 'شارع مولاي إسماعيل، المدينة الجديدة',
    'campaign.2.description': 'ساعد في استعادة جمال حدائق المدينة الجديدة. غرس الأشجار وجمع القمامة وإصلاح المقاعد.',
    'campaign.3.title': 'تنظيف عميق لسوق الحامري',
    'campaign.3.location': 'سوق الحامري، الحامري',
    'campaign.3.description': 'تنظيف شامل لمنطقة سوق الحامري. التركيز على فرز النفايات والتوعية بإعادة التدوير.',
    'campaign.4.title': 'تنظيف مسار برج بلكاري',
    'campaign.4.location': 'برج بلكاري، طريق فاس',
    'campaign.4.description': 'تنظيف مسار في الهواء الطلق على طول طريق برج بلكاري الخلاب. رائع لعشاق الطبيعة.',

    'contact.label': 'اتصل بنا',
    'contact.heading': 'تواصل معنا',
    'contact.body': 'لديك أسئلة حول التطوع أو الشراكات أو تنظيم حملة تنظيف في حيك؟ تواصل معنا — نرد خلال 24 ساعة.',
    ...
    'socialFeed.subheading': 'تابع رحلتنا وشاهد ما تشاركه مجتمعاتنا عبر المنصات.',
    'sponsors.label': 'الشركاء',
    'partners.empty': 'لا يوجد شركاء بعد.',
    'sponsors.heading': 'شركاؤنا وداعمونا',
    'sponsors.subheading': 'منظمات وأعمال تجارية تدعم مهمتنا من أجل مكناس أنظف.',
    'gallery.heading': 'قبل وبعد',
    'gallery.subheading': 'شاهد التأثير الحقيقي الذي يحدثه متطوعونا في جميع أنحاء مكناس.',
    'gallery.before': 'قبل',
    'gallery.after': 'بعد',
    ...
    'login.title': 'مرحباً',
    'login.or': 'أو',
    'login.terms': 'بتسجيل الدخول، فإنك توافق على شروط الخدمة وسياسة الخصوصية الخاصة بنا.',
    ...
    'air_quality.subheading': 'بيانات جودة الهواء المباشرة لمكناس. تحديث كل ساعة من Open-Meteo.',
    'air_quality.advice_good': 'جودة الهواء جيدة. استمتع بالأنشطة الخارجية!',
    'air_quality.advice_moderate': 'جودة الهواء متوسطة. يجب على الأشخاص الحساسين تحديد الجهد الخارجي المطول.',
    'air_quality.advice_sensitive': 'جودة الهواء غير صحية للمجموعات الحساسة. فكر في ارتداء قناع في الخارج.',
    'air_quality.advice_unhealthy': 'جودة الهواء غير صحية. تجنب الأنشطة الخارجية المطولة وارتدِ قناعاً.',
    ...
    'air_quality.scale_desc': 'مؤشر جودة الهواء (AQI) يتراوح من 0 إلى 500. كلما ارتفعت القيمة، زاد مستوى تلوث الهواء والقلق الصحي.',
    'air_quality.how_title': 'فهم جودة الهواء',
    'air_quality.what_is_aqi': 'ما هو مؤشر جودة الهواء؟',
    'air_quality.what_is_aqi_desc': 'مؤشر جودة الهواء (AQI) هو مقياس موحد يُستخدم على مستوى العالم للتواصل حول مدى تلوث الهواء حالياً أو المتوقب. يحول قياسات الملوثات المعقدة إلى رقم واحد سهل الفهم.',
    'air_quality.how_measured': 'كيف يتم قياسه؟',
    'air_quality.how_measured_desc': 'تقيس محطات جودة الهواء تراكيز الملوثات الرئيسية في الغلاف الجوي — PM2.5، PM10، NO₂، SO₂، CO، وO₃. تُدخل هذه القياسات في صيغة تحسب قيمة AQI واحدة. الملوث ذو أعلى مؤشر فردي يحدد مؤشر AQI الإجمالي.',
    'air_quality.pollutants_title': 'ما هي هذه الملوثات؟',
    'air_quality.pollutants_desc': 'PM2.5 وPM10 هي جسيمات صلبة أو سائلة صغيرة جداً معلقة في الهواء. يأتي NO₂ بشكل أساسي من عوادم المركبات والانبعاثات الصناعية. يُنتج SO₂ عن حرق الوقود الأحفوري. CO هو غاز عديم اللون ناتج عن الاحتراق غير الكامل. يتشكل O₃ (الأوزون) عندما تتفاعل أشعة الشمس مع ملوثات أخرى.',
    'air_quality.data_source': 'من أين تأتي هذه البيانات؟',
    'air_quality.data_source_desc': 'تأتي هذه البيانات من Open-Meteo، وهي واجهة برمجة تطبيقات عالمية للطقس وجودة الهواء تجمع البيانات من محطات المراقبة الوطنية والمراقبة بالأقمار الصناعية. عندما تكون البيانات المباشرة غير متوفرة، نعرض قيم محاكاة واقعية بناءً على الظروف النموذجية لمكناس.',
    ...
    'error.modal.network': 'خطأ في الشبكة. يرجى التحقق من الاتصال والمحاولة مرة أخرى.',
    'error.modal.auth': 'فشل المصادقة. يرجى تسجيل الدخول مرة أخرى.',
    'error.modal.generic': 'حدث خطأ ما. يرجى المحاولة مرة أخرى.',
    'error.modal.oauth_denied': 'تم إلغاء تسجيل الدخول. يمكنك المحاولة مرة أخرى في أي وقت.',
    'error.modal.oauth_failed': 'فشل تسجيل الدخول. يرجى المحاولة مرة أخرى أو استخدام طريقة أخرى.',
    'error.modal.rate_limit': 'محاولات كثيرة جداً. يرجى الانتظار قليلاً والمحاولة مرة أخرى.',
    'error.modal.csrf': 'فشل التحقق الأمني. يرجى المحاولة مرة أخرى.',
    'error.modal.pkce': 'انتهت جلسة تسجيل الدخول. يرجى المحاولة مرة أخرى.',
    'error.modal.redirect': 'إعادة توجيه غير صالحة. يرجى المحاولة مرة أخرى من الصفحة الرئيسية.',
    ...
    'neighborhoods.subheading': 'اكتشف المجتمعات التي نخدمها في جميع أنحاء مكناس.',
    ...
    'share.text': 'انضم إلى حملة تنظيف {title} في مكناس يوم {date}! {description}',
