...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.users.header.two_factor": "2FA",
    "admin.users.header.role": "Role",
    "admin.users.header.status": "Status",
    "admin.users.header.last_sign_in": "Last Sign In",
    ...
    "admin.users.role.content_manager": "Content Manager",
    "admin.users.role.volunteer_coordinator": "Volunteer Coordinator",
    ...
    "admin.users.registrations_label": "Registrations",
    "admin.users.attended_label": "Attended",
    "admin.users.role_label": "Role",
    "admin.users.account_status": "Account Status",
    "admin.users.two_factor": "Two-Factor Authentication",
    ...
    "admin.users.delete_description": "Are you sure you want to permanently delete {name}? This action cannot be undone.",
    ...
    "toast.delete_user_failed": "Failed to delete user",
  ...
  fr: {
    ...
    "admin.users.header.user": "Utilisateur",
    "admin.users.header.two_factor": "2FA",
    "admin.users.header.role": "Rôle",
    "admin.users.header.status": "Statut",
    "admin.users.header.last_sign_in": "Dernière connexion",
    "admin.users.header.joined": "Inscrit le",
    "admin.users.no_email": "Aucun e-mail",
    "admin.users.role.super_admin": "Super Admin",
    "admin.users.role.admin": "Admin",
    "admin.users.role.content_manager": "Gestionnaire de contenu",
    "admin.users.role.volunteer_coordinator": "Coordinateur bénévoles",
    "admin.users.role.viewer": "Lecteur",
    ...
    "admin.users.local": "Local",
    "admin.users.registrations_label": "Inscriptions",
    "admin.users.attended_label": "Présences",
    "admin.users.role_label": "Rôle",
    "admin.users.account_status": "Statut du compte",
    "admin.users.two_factor": "Authentification à deux facteurs",
    "admin.users.delete_account": "Supprimer le compte",
    "admin.users.campaign_history": "Historique des campagnes",
    "admin.users.delete_title": "Supprimer l'utilisateur",
    "admin.users.delete_description": "Voulez-vous vraiment supprimer définitivement {name} ? Cette action est irréversible.",
    ...
    "toast.delete_user_failed": "Échec de la suppression de l'utilisateur",
  ...
  ar: {
    ...
    "admin.users.header.last_sign_in": "آخر تسجيل دخول",
    "admin.users.header.joined": "تاريخ الانضمام",
    "admin.users.no_email": "لا يوجد بريد إلكتروني",
    "admin.users.role.super_admin": "مدير أعلى",
    "admin.users.role.admin": "مدير",
    "admin.users.role.content_manager": "مدير المحتوى",
    "admin.users.role.volunteer_coordinator": "منسق المتطوعين",
    ...
    "admin.users.registrations_label": "التسجيلات",
    "admin.users.attended_label": "الحضور",
    "admin.users.role_label": "الدور",
    "admin.users.account_status": "حالة الحساب",
    "admin.users.two_factor": "المصادقة الثنائية",
    "admin.users.delete_account": "حذف الحساب",
    "admin.users.campaign_history": "تاريخ الحملات",
    "admin.users.delete_title": "حذف المستخدم",
    "admin.users.delete_description": "هل تريد بالتأكيد حذف {name} نهائياً؟ لا يمكن التراجع عن هذا الإجراء.",
    ...
    "toast.delete_user_failed": "فشل حذف المستخدم",
