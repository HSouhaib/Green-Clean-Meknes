...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.leaderboard.points_system_help": "Set how many points volunteers earn automatically when they register for a campaign, when their attendance is confirmed, and for every kilogram of waste collected in campaigns they attend.",
  ...
  fr: {
    ...
    "admin.leaderboard.points_system_help": "Définissez combien de points les bénévoles gagnent automatiquement lors de l'inscription à une campagne, lorsque leur présence est confirmée, et pour chaque kilogramme de déchets collectés lors des campagnes auxquelles ils participent.",
  ...
  ar: {
    ...
    "admin.leaderboard.points_system_help": "حدد عدد النقاط التي يكتسبها المتطوعون تلقائياً عند التسجيل في حملة، وتأكيد حضورهم، ولكل كيلوغرام من النفايات المجمعة في الحملات التي يشاركون فيها.",
