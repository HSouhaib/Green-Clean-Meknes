...
export default function GuestRegisterModal({
  ...
  const inputStyle = (field: string): React.CSSProperties => ({
    ...
    border: focusedField === field ? '1.5px solid var(--accent-green)' : '1.5px solid var(--bg-surface-light)',
    borderRadius: '12px',
    ...
    boxShadow: focusedField === field ? '0 0 0 3px rgba(107, 142, 90, 0.12)' : 'none',
  });
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold" style={{ color: 'var(--text-primary)' }}>
                  {submitted ? 'Registration Complete' : 'Join Campaign'}
                </h3>
                {!submitted && (
