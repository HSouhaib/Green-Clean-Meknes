...
export default function Login() {
  ...
  return (
    ...
    >
      ...
      {isAuthenticated ? (
        // 2FA just succeeded and the redirect home is in flight — show a
        // spinner instead of flashing the signed-in card.
        pending2fa ? (
          <Spinner
            className="size-8"
          ...
          >
            ...
            <CardContent className="p-6 text-center">
              ...
              >
                ...
                >
                  {roleLabelByName(user?.role ?? "user", undefined, lang, t)}
                </span>
                .
              </p>
