...
export default function Admin() {
  ...
  const { data: pendingVolunteers } = trpc.volunteer.pendingCount.useQuery(
    undefined,
    {
      refetchInterval: 30000,
    }
  );
  const { data: totalRegistrations } =
    trpc.campaign.registrationTotalCount.useQuery(undefined, {
      refetchInterval: 30000,
    });
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg-primary)" }}>
      ...
      >
        <div
          className="flex items-center justify-between mx-auto px-4 sm:px-6 py-3"
