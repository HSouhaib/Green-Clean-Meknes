...
async function seed() {
  ...
  const sampleCampaigns = [
    ...
    },
    {
      ...
      image: "/assets/campaign-borj-belkari.jpg",
  ...
  const defaultSettings = [
    ...
    {
      key: "donation_description_fr",
      value:
        "Votre contribution nous aide a organiser plus de nettoyages et a sensibiliser les gens a travers Meknes.",
    },
    {
      key: "donation_description_ar",
      value:
        "مساهمتك تساعدنا في تنظيم المزيد من حملات التنظيف ونشر الوعي في جميع أنحاء مكناس.",
    },
    {
      key: "footer_tagline_fr",
      value: "Rues Plus Propres. Parcs Plus Verts. Communaute Plus Forte.",
    },
    { key: "footer_tagline_ar", value: "شوارع أنظف. حدائق أخضر. مجتمع أقوى." },
    {
      key: "footer_copyright_fr",
      value: "2025 Green Clean Meknes. Tous droits reserves.",
    },
    {
      key: "footer_copyright_ar",
      value: "2025 جرين مكناس. جميع الحقوق محفوظة.",
    },
    { key: "social_show_instagram", value: "true" },
    { key: "social_show_facebook", value: "true" },
    {
      key: "footer_tagline",
      value: "Building a cleaner, greener Meknes — one neighborhood at a time.",
    },
  ...
  const sampleTestimonials = [
    {
      ...
      quoteEn:
        "Joining Green Clean Meknes changed how I see my city. I used to walk past litter without noticing. Now I stop and pick it up. The community we built is incredible.",
      quoteAr:
        "غيرت مكناس الخضراء النظيفة طريقة رؤيتي لمدينتي. كنت أمشي بجانب القمامة دون ملاحظتها. الآن أتوقف وألتقطها. المجتمع الذي بنيناه لا يصدق.",
      quoteFr:
        "Rejoindre Green Clean Meknes a change ma facon de voir ma ville. Avant, je marchais devant les dechets sans les remarquer. Maintenant, je m'arrete et je les ramasse. La communaute que nous avons construite est incroyable.",
      sortOrder: 0,
      isActive: true,
    },
    {
      ...
      quoteEn:
        "I organized my first cleanup in Hamria with just 5 friends. Now we have 40+ people showing up every month. The transformation of our streets is visible to everyone.",
      quoteAr:
        "نظمت أول حملة تنظيف لي في الحمريّة مع 5 أصدقاء فقط. الآن لدينا 40+ شخص يحضرون كل شهر. تحول شوارعنا واضح للجميع.",
      quoteFr:
        "J'ai organise ma premiere campagne de nettoyage a Hamria avec seulement 5 amis. Maintenant, nous avons plus de 40 personnes qui se presentent chaque mois. La transformation de nos rues est visible pour tout le monde.",
      sortOrder: 1,
      isActive: true,
    },
    {
      ...
      quoteEn:
        "As an engineering student, I wanted to do something practical for my city. The data we collect on waste types helps us understand pollution patterns. It's science in action.",
      quoteAr:
        "كطالب هندسة، أردت أن أفعل شيئًا عمليًا لمدينتي. البيانات التي نجمعها عن أنواع النفايات تساعدنا في فهم أنماط التلوث. إنها العلم في العمل.",
      quoteFr:
        "En tant qu'etudiant en ingenierie, je voulais faire quelque chose de pratique pour ma ville. Les donnees que nous collectons sur les types de dechets nous aident a comprendre les modeles de pollution. C'est la science en action.",
      sortOrder: 2,
      isActive: true,
    },
  ];
  ...
  const sampleFaqs = [
    ...
    },
    {
      ...
      answerEn:
        "Absolutely! Contact us through the form below and we'll help you plan and promote a cleanup in your area.",
      answerFr:
  ...
  const defaultRoles = [
    ...
    },
    {
      ...
      labelFr: "Gestionnaire de Contenu",
    ...
    },
    {
      ...
      labelEn: "Volunteer Coordinator",
      labelFr: "Coordinateur de Bénévoles",
      labelAr: "منسق المتطوعين",
      permissions: JSON.stringify([
        "dashboard.view",
        "campaigns.view",
        "contacts.view",
  ...
  const sampleSocialPosts = [
    {
      ...
      captionEn:
        "Amazing turnout at Bab Mansour cleanup! 50+ volunteers made a real difference.",
      captionFr:
        "Incroyable participation au nettoyage de Bab Mansour ! Plus de 50 bénévoles ont fait la différence.",
      captionAr:
        "مشاركة رائعة في حملة تنظيف باب المنصور! أكثر من 50 متطوع أحدثوا فرقًا حقيقيًا.",
    ...
    },
    {
      ...
      captionEn:
        "Before and after at Hamria district. The transformation is incredible!",
      captionFr:
        "Avant et après dans le quartier Hamria. La transformation est incroyable !",
    ...
    },
    {
      ...
      captionEn:
        "Tree planting day in Ville Nouvelle. 120 new trees for a greener Meknes!",
      captionFr:
        "Journée de plantation d'arbres à la Ville Nouvelle. 120 nouveaux arbres pour un Meknès plus vert !",
      captionAr:
        "يوم زراعة الأشجار في المدينة الجديدة. 120 شجرة جديدة لمكناس أكثر خضرة!",
